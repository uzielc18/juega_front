...
@Component({
  ...
  templateUrl: './m-areas.component.html',
  styleUrls: ['./m-areas.component.scss']
})
export class MAreasComponent implements OnInit {
  ...
  @Input() code: any;
  @Input() userInfo: any;
  constructor(public activeModal: NbDialogRef<MAreasComponent>,
